...
Prescription.create!(name: "Aderall", dosage: 300, legality: true, drugstore: d1, customer: c1)
Prescription.create!(name: "Antidepressents", dosage: 120, legality: true, drugstore: d2, customer: c2)
Prescription.create!(name: "Robitussin", dosage: 100, legality: false, drugstore: d2, customer: c3)
Prescription.create!(name: "Devil's Lettuce", dosage: 400, legality: false, drugstore: d1, customer: c2)
